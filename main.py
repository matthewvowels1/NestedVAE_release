...
def main(args):
	...
	# Get data
	train_data, test_data, target_task_train, target_task_val, sensitive_train, sensitive_val = get_data(dataset=dataset, data_dir=data_dir, seed=None)
	...
	outer_VAE = model.outerVAE(in_size=train_data.shape[1],
	...
	BAC_outer_sensitive = tester.predict_label(train_X=outer_embeddings_train, test_X=outer_embeddings_test, train_y=sensitive_train,
	...
	BAC_inner_sensitive = tester.predict_label(train_X=inner_embeddings_train, test_X=inner_embeddings_test, train_y=sensitive_train,
	                                         test_y=sensitive_val)
